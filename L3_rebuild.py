...
def train(model, args, train_dataset, train_dataloader, dev_dataset, dev_dataloader, epochs):
...
def evaluate(candidate, args, model):
    ...
    print("Now create attention masks too")
    attn_masks = []
...
#                         help="The name of the task to train selected in the list: " + ", ".join(processors.keys()))
    ...
    if args.do_train:
        ...
        train(model, args, train_dataset, train_dataloader, dev_dataset, dev_dataloader, epochs = 4)
